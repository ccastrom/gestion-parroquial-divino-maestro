...
} = require('../../controllers/web/tramite.controllers.js');
const {
    POST_CrearParticipante_Web,
    POST_EditarRolParticipante_Web,
    POST_EliminarParticipante_Web,
} = require('../../controllers/web/participante.controllers.js');
const {
    POST_AgregarDocumento_Web,
    POST_ModificarDocumento_Web,
} = require('../../controllers/web/documento.controllers.js');
const {
    POST_CambiarReunion_Web,
    POST_CompletarReunion_Web,
} = require('../../controllers/web/reunion.controllers.js');
